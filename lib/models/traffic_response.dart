...
//
//     final trafficRes = trafficResFromMap(jsonString);
...
class TrafficRes {
  ...
  factory TrafficRes.fromJson(String str) =>
      TrafficRes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TrafficRes.fromMap(Map<String, dynamic> json) => TrafficRes(
