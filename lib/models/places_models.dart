...
//
//     final placesRes = placesResFromMap(jsonString);
...
class PlacesRes {
  ...
  factory PlacesRes.fromJson(String str) => PlacesRes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PlacesRes.fromMap(Map<String, dynamic> json) => PlacesRes(
        type: json["type"],
